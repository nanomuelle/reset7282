...
#define PONG_WORLD_TO_SCREEN_X(x)          (PONG_SYS_RENDER_ENTITY_OFFSET_X + (PONG_SYS_RENDER_PHY_TO_PX(x)))
#define PONG_WORLD_TO_SCREEN_Y(y)          (PONG_SYS_RENDER_ENTITY_OFFSET_Y + (PONG_SYS_RENDER_PHY_TO_PX(y)))
