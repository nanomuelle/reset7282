...
#define EPS_WORLD_MAX_X        ( EPS_WORLD_W - 1 )
#define EPS_WORLD_MIN_Y        ( 0 )
#define EPS_WORLD_MAX_Y        ( EPS_WORLD_H - 1 )

#define EPS_MAX_ENTITIES       10
...
extern u8   epx_check_collision(TEEM_entity *e1, TEEM_entity *e2);
